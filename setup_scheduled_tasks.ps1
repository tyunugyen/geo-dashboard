...
# Task 2: Weekly Fill (Every Monday at 9:25 AM)
...
$trigger2 = New-ScheduledTaskTrigger -Weekly -DaysOfWeek Monday -At 9:25AM
...
# Task 3: Monthly Benchmark (First Monday of month at 10:00 AM)
...
# Task 4: Monthly Fill (First Monday of month at 10:25 AM)
...
$trigger4 = New-ScheduledTaskTrigger -Weekly -DaysOfWeek Monday -At 10:25AM
...
Write-Host "    9:25 AM  - Weekly Fill (~3 min)"
Write-Host ""
Write-Host "  First Monday of month:"
Write-Host "    10:00 AM - Monthly Benchmark (~20 min)"
Write-Host "    10:25 AM - Monthly Fill (~3 min)"
Write-Host ""
